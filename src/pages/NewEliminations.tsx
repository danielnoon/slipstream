...
import { close, save, trophy } from "ionicons/icons";
import { useEffect, useState } from "react";
import { participantSorter } from "../algorithms";
import { ElimsScoreEntryModal } from "../components/ElimsScoreEntryModal";
...
export function NewEliminations() {
  ...
  const actions = [
    { icon: <IonIcon slot="icon-only" icon={save} />, name: 'Score Entry' },
  ];
  ...
  return (
    <IonPage>
      ...
      <IonContent className="ion-padding">
                ...
                {active.find((a) => participant.id === a.id) &&
                  active.length == 3 && (
                    ...
                    >
                      ...
                      <IonIcon size="medium" slot="end" icon={save} />
                    </IonButton>
                  )}
              </IonCardContent>
            </IonCard>
        ...
        <SpeedDial
          ariaLabel="Elimination view options"
        ...
        <ElimsScoreEntryModal
          id={tournament!.currElimRound}
